document.addEventListener('DOMContentLoaded', () => {
    ...
    const addTask = (text, completed = false, fromUserInput = true) => {
        const taskText = fromUserInput ? taskInput.value.trim() : text;
        if (!taskText) {
            return;
        }
...
const Confetti = () => {
    ...
    const interval = setInterval(() => {
        ...
        fire(0.1, { spread: 120, startVelocity: 55, scalar: 1.2, origin: { y } });
